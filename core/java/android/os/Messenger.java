...
public final class Messenger implements Parcelable {
    ...
    public boolean equals(Object otherObj) {
        ...
        try {
            return ((IBinder)mTarget).equals((IBinder)((Messenger)otherObj)
                    .mTarget);
    ...
    public int hashCode() {
        return ((IBinder)mTarget).hashCode();
    }
    ...
    public void writeToParcel(Parcel out, int flags) {
        out.writeStrongBinder((IBinder)mTarget);
    }
    ...
    public static void writeMessengerOrNullToParcel(Messenger messenger,
            Parcel out) {
        out.writeStrongBinder(messenger != null ? (IBinder)messenger.mTarget
                : null);
    }
