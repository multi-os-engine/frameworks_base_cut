...
public final class SQLiteGlobal {
    ...
    public static int getDefaultPageSize() {
        synchronized (sLock) {
            ...
            return Integer.getInteger("debug.sqlite.pagesize", sDefaultPageSize);
        }
    }
    ...
    public static String getDefaultJournalMode() {
        return System.getProperty("debug.sqlite.journalmode", "PERSIST");
    }
    ...
    public static int getJournalSizeLimit() {
        return Integer.getInteger("debug.sqlite.journalsizelimit", 524288);
    }
    ...
    public static String getDefaultSyncMode() {
        return System.getProperty("debug.sqlite.syncmode", "FULL");
    }
    ...
    public static String getWALSyncMode() {
        return System.getProperty("debug.sqlite.wal.syncmode","FULL");
    }
    ...
    public static int getWALAutoCheckpoint() {
        int value = Integer.getInteger("debug.sqlite.wal.autocheckpoint", 100);
    ...
    public static int getWALConnectionPoolSize() {
        int value = Integer.getInteger("debug.sqlite.wal.poolsize", 4);
