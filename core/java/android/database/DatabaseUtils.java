...
public class DatabaseUtils {
    ...
    public static String concatenateWhere(String a, String b) {
        if (/*TextUtils.isEmpty*/(a==null || a.length()==0)) {
            return b;
        }
        if (/*TextUtils.isEmpty*/(b==null || b.length()==0)) {
            return a;
        }
    ...
    public static long queryNumEntries(SQLiteDatabase db, String table, String selection,
        ...
        String s = (!/*TextUtils.isEmpty*/(selection==null || selection.length()==0)) ? " where " + selection : "";
